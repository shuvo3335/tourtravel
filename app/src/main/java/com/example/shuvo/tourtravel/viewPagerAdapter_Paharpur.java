...
public class viewPagerAdapter_Paharpur extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.sompur,R.drawable.paharpur1,R.drawable.paharpur2,R.drawable.paharpur3};

    viewPagerAdapter_Paharpur(Context context){
