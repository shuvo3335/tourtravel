...
public class viewPagerAdapter_rajbari extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.rajbari4,R.drawable.rajbari1,R.drawable.rajbari3
            ,R.drawable.natore_raj};

    viewPagerAdapter_rajbari(Context context){
