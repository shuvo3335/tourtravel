...
public class viewPagerAdapter_madhabkundo extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.madhab_water,R.drawable.madhab_eco,R.drawable.madhab2
            ,R.drawable.madhabkundo1};

    viewPagerAdapter_madhabkundo(Context context){
