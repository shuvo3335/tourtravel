...
public class viewPagerAdapter_kuakata extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.kuakata,R.drawable.kuakata1,R.drawable.kuakata2
            ,R.drawable.saint2};

    viewPagerAdapter_kuakata(Context context){
