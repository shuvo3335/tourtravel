...
public class viewPagerAdapter_patenga extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.potenga,R.drawable.potenga1,R.drawable.potenga2
            ,R.drawable.potenga3};

    viewPagerAdapter_patenga(Context context){
