...
public class viewPagerAdapter_COX extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.cox,R.drawable.inani,R.drawable.laboni,R.drawable.kolatoli};

    viewPagerAdapter_COX(Context context){
