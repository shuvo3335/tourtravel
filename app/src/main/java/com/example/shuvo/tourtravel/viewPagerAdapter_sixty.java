...
public class viewPagerAdapter_sixty extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.shat1,R.drawable.shat,R.drawable.shat2};

    viewPagerAdapter_sixty(Context context){
