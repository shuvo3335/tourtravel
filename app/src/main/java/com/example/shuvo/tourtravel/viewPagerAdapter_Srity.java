...
public class viewPagerAdapter_Srity extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.sritysoudho,R.drawable.srity2};

    viewPagerAdapter_Srity(Context context){
