...
public class viewPagerAdapter_jadipai extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.jadipai,R.drawable.jadipai1,R.drawable.jadipai2
            ,R.drawable.humhum3};

    viewPagerAdapter_jadipai(Context context){
