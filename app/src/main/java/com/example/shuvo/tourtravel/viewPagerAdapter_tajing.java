...
public class viewPagerAdapter_tajing extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.tajingdong,R.drawable.tajingdong1,R.drawable.tajingdong2};

    viewPagerAdapter_tajing(Context context){
