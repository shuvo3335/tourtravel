...
public class viewPagerAdapter_nafakum extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.nafakum,R.drawable.nafakum1,R.drawable.nafa2
            ,R.drawable.nafa3};

    viewPagerAdapter_nafakum(Context context){
