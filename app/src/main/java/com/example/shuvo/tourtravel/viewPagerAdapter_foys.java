...
public class viewPagerAdapter_foys extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.foys_lake,R.drawable.foys1,R.drawable.foys2,R.drawable.foys3};

    viewPagerAdapter_foys(Context context){
