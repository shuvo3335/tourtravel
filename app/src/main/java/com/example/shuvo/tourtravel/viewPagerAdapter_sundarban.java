...
public class viewPagerAdapter_sundarban extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.sundarban1,R.drawable.sundarban2,R.drawable.sundarban4};

    viewPagerAdapter_sundarban(Context context){
