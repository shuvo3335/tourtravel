...
public class viewPagerAdapter_ahsan extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.ahsan_manjil,R.drawable.ahsan1};

    viewPagerAdapter_ahsan(Context context){
