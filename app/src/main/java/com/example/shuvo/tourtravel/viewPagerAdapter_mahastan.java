...
public class viewPagerAdapter_mahastan extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.manasthangarh,R.drawable.mahastan2,R.drawable.mahastan3,R.drawable.mahastan1};

    viewPagerAdapter_mahastan(Context context){
