...
public class weatherActivity extends AppCompatActivity {
    ...
    String weatherWebserviceURL = "http://api.openweathermap.org/data/2.5/weather?q=Dhaka,Bangladesh,tn&appid=481ca029ecc2a73a7ed5f789698b920d&units=metric";
    //the loading Dialog
            ...
            JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        } else if (jsonObj.getString("main").equals("Sunny")) {
                            backgroundImage = "https://bangladesh-traveling.000webhostapp.com/uploads/49e58dfc85cd70f7e13167ea2cf3467e.jpg";
                        }
