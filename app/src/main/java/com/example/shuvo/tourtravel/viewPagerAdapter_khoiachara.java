...
public class viewPagerAdapter_khoiachara extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.khoichara,R.drawable.khoiachora1,R.drawable.khoichara2};

    viewPagerAdapter_khoiachara(Context context){
