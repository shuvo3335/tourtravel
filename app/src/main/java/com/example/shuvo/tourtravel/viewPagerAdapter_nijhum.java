...
public class viewPagerAdapter_nijhum extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.nijhum_beach,R.drawable.nijhum1,R.drawable.nijhum2
            ,R.drawable.nijhum3};

    viewPagerAdapter_nijhum(Context context){
