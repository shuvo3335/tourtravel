...
public class viewPagerAdapter_Sajek extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.sajek2,R.drawable.sajek1,R.drawable.sajek};

    viewPagerAdapter_Sajek(Context context){
