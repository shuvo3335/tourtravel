...
public class viewPagerAdapter_keukradong extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.keukradang,R.drawable.kewkra1,R.drawable.kewkra2};

    viewPagerAdapter_keukradong(Context context){
