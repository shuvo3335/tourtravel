...
public class viewPagerAdapter_sonargao extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.sonarga,R.drawable.sonargaon_museum};

    viewPagerAdapter_sonargao(Context context){
