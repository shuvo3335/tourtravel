...
public class viewPagerAdapter_Saint extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.saint_martin,R.drawable.saint_martin_island,R.drawable.saint1
            ,R.drawable.saint2};

    viewPagerAdapter_Saint(Context context){
