...
public class viewPagerAdapter_Chimbuk extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.chimbuk,R.drawable.chimbuk1,R.drawable.chimbuk3};

    viewPagerAdapter_Chimbuk(Context context){
