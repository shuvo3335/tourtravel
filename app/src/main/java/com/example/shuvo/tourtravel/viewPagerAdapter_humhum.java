...
public class viewPagerAdapter_humhum extends PagerAdapter {
    private Context context;
    private Integer [] images = {R.drawable.humhum,R.drawable.humhum1,R.drawable.humhum2
            ,R.drawable.humhum3};

    viewPagerAdapter_humhum(Context context){
